...
def getWordScore(word, n):
    ...
    # Add each char value to the score
    for char in word:
    ...
    # Bonus points for using all letters on first go
    if len(word) == n:
        score += 50
...
def isValidWord(word, hand, wordList):
    ...
    """
    # Check if word can be made by current hand
    handCopy = hand.copy()
    for char in word:
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:  
        ...
        if userInput != ".":
            ...
            # Otherwise (the word is valid):
                ...
                print(userInput + " earned " + str(getWordScore(userInput, n)) + " points. Total: " + str(totalScore) + " points")
                print("")
                # Update the hand 
    ...
    print(endString + "Total score: " + str(totalScore) + " points.")
